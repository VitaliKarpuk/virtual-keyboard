class Keyboard {
  constructor() {
      ...
      this.keyLayout = [
          ["`", "ё", "Backquote"], ["1", "1", "Digit1"], ["2", "2", "Digit2"], ["3", "3", "Digit3"], ["4", "4", "Digit4"], ["5", "5", "Digit5"], ["6", "6", "Digit6"], ["7", "7", "Digit7"], ["8", "8", "Digit8"], ["9", "9", "Digit9"], ["0", "0", "Digit0"], ["-", "_", "Minus"], ["=", "+", "Equal"], ["Backspace", "Backspace", "Backspace"],
 ...
 initVertual () {
      ...
      this.elements.info = document.createElement('ul');
      this.elements.info.classList.add('keyboard__info');
      this.elements.main.appendChild(this.elements.info)
      this.elements.info.innerHTML = '<li>На Windows</li> <li>Смена языка - Shift + Alt</li>'
      ...
      default:
        this.keyLayout.forEach((item) => {
          if (item[2] === event.code) {
            // english
            if (+this.properties.isRrussian !== 0) {
              if (!this.properties.capsLock) {
